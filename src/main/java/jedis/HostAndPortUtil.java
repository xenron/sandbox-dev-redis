...
public class HostAndPortUtil {
  ...
  static {
    redisHostAndPortList.add(new HostAndPort("192.168.5.128", Protocol.DEFAULT_PORT));
    redisHostAndPortList.add(new HostAndPort("192.168.5.128", Protocol.DEFAULT_PORT + 1));
